                    ...
                    <form method="POST" action="{{ route('admin.jabatan.update', $jabatan->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="kode_jabatan" value="{{ old('kode_jabatan', $jabatan->kode_jabatan) }}" required 
                            ...
                            <div>
                                ...
                                <select name="departemen_id" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    ...
                                    @foreach($departemens as $departemen)
                                        <option value="{{ $departemen->id }}" {{ old('departemen_id', $jabatan->departemen_id) == $departemen->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="number" name="gaji_minimal" value="{{ old('gaji_minimal', $jabatan->gaji_minimal) }}" 
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                @error('gaji_minimal')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="gaji_maksimal" value="{{ old('gaji_maksimal', $jabatan->gaji_maksimal) }}" 
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                @error('gaji_maksimal')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="deskripsi" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('deskripsi', $jabatan->deskripsi) }}</textarea>
                            </div>
                        </div>
