                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok', '0') }}" required 
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                        <input type="text" id="total_tunjangan" name="total_tunjangan" value="{{ old('total_tunjangan', '0') }}" required 
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                        <input type="text" id="uang_lembur" name="uang_lembur" value="{{ old('uang_lembur', '0') }}" required 
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                        <input type="text" id="bonus" name="bonus" value="{{ old('bonus', '0') }}" required 
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                        ...
                        <div class="border-t pt-6 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                        <input type="text" id="jumlah_pajak" name="jumlah_pajak" value="{{ old('jumlah_pajak', '0') }}" required 
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                        <input type="text" id="potongan_bpjs" name="potongan_bpjs" value="{{ old('potongan_bpjs', '0') }}" required 
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                        <input type="text" id="total_potongan" name="total_potongan" value="{{ old('total_potongan', '0') }}" required 
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                        ...
                        <div class="border-t pt-6 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal_pembayaran" value="{{ old('tanggal_pembayaran') }}" 
                                        class="shadow border rounded w-full py-2 px-3">
                                </div>
