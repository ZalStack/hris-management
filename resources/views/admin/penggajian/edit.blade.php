                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <select name="bulan" id="bulan" required
                                    ...
                                    @foreach ($bulan as $b)
                                        <option value="{{ $b }}"
                                            {{ old('bulan', $penggajian->bulan) == $b ? 'selected' : '' }}>
                                            @php
                                                $bulanNama = [
                                                    1 => 'Januari',
                                                    2 => 'Februari',
                            ...
                            <div>
                                ...
                                <select name="tahun" id="tahun" required
                                    ...
                                    @foreach ($tahun as $t)
                                        <option value="{{ $t }}"
                                            {{ old('tahun', $penggajian->tahun) == $t ? 'selected' : '' }}>
                                            {{ $t }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="total_tunjangan" name="total_tunjangan"
                                            value="{{ old('total_tunjangan', $penggajian->total_tunjangan) }}" required
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="uang_lembur" name="uang_lembur"
                                            value="{{ old('uang_lembur', $penggajian->uang_lembur) }}" required
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="bonus" name="bonus"
                                            value="{{ old('bonus', $penggajian->bonus) }}" required
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="jumlah_pajak" name="jumlah_pajak"
                                            value="{{ old('jumlah_pajak', $penggajian->jumlah_pajak) }}" required
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="potongan_bpjs" name="potongan_bpjs"
                                            value="{{ old('potongan_bpjs', $penggajian->potongan_bpjs) }}" required
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="total_potongan" name="total_potongan"
                                            value="{{ old('total_potongan', $penggajian->total_potongan) }}" required
                                            class="shadow border rounded w-full pl-10 pr-3 py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            onkeyup="formatRupiah(this); calculateTotal()">
                                    </div>
                                </div>
                            ...
                            <div class="bg-blue-50 rounded-lg p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                            <input type="text" id="gaji_bersih" name="gaji_bersih"
                                                value="{{ old('gaji_bersih', $penggajian->gaji_bersih) }}" required
                                ...
                                <div>
                                    ...
                                    <select name="status" required class="shadow border rounded w-full py-2 px-3">
                                        ...
                                        <option value="pending"
                                            {{ old('status', $penggajian->status) == 'pending' ? 'selected' : '' }}>
                                            Pending Approval</option>
                                        <option value="approved"
                                            {{ old('status', $penggajian->status) == 'approved' ? 'selected' : '' }}>
                                            Approved</option>
                                        <option value="paid"
                                            {{ old('status', $penggajian->status) == 'paid' ? 'selected' : '' }}>Paid
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="metode_pembayaran" class="shadow border rounded w-full py-2 px-3">
                                        ...
                                        <option value="transfer"
                                            {{ old('metode_pembayaran', $penggajian->metode_pembayaran) == 'transfer' ? 'selected' : '' }}>
                                            Transfer Bank</option>
                                        <option value="tunai"
                                            {{ old('metode_pembayaran', $penggajian->metode_pembayaran) == 'tunai' ? 'selected' : '' }}>
                                            Tunai</option>
                                        <option value="cek"
                                            {{ old('metode_pembayaran', $penggajian->metode_pembayaran) == 'cek' ? 'selected' : '' }}>
                                            Cek</option>
                                    </select>
                                </div>
