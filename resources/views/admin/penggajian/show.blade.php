<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Detail Penggajian - {{ $penggajian->bulan_text }} {{ $penggajian->tahun }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">{{ $penggajian->bulan_text }} {{ $penggajian->tahun }}</p>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6 pb-4 border-b">
                        ...
                        <div>
                            ...
                            <p class="font-semibold">{{ $penggajian->karyawan->nip ?? '-' }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-semibold">{{ $penggajian->dibuat_oleh }}</p>
                        </div>
                    </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="font-semibold text-red-600">- Rp
                                            {{ number_format($penggajian->jumlah_pajak, 0, ',', '.') }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-600 text-sm">Potongan BPJS</p>
                                        <p class="font-semibold text-red-600">- Rp
                                            {{ number_format($penggajian->potongan_bpjs, 0, ',', '.') }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-600 text-sm">Total Potongan</p>
                                        <p class="font-semibold text-red-600">- Rp
                                            {{ number_format($penggajian->total_potongan, 0, ',', '.') }}</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-green-600">Rp
                                            {{ number_format($penggajian->gaji_bersih, 0, ',', '.') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($detailGaji['detail_lembur'] as $lembur)
                                            <tr>
                                                ...
                                                <td class="py-1">{{ number_format($lembur['total_jam'], 2) }} jam
                                                </td>
                                                <td class="py-1 text-right">Rp
                                                    {{ number_format($lembur['total_lembur'], 0, ',', '.') }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="font-semibold">
                                            {{ $penggajian->tanggal_pembayaran ? $penggajian->tanggal_pembayaran->format('d/m/Y') : '-' }}
                                        </p>
                                    </div>
                                    <div>
